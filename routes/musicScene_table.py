...
def edittbl():
    ...
    return render_template('musicScene_table.html',items=data,volume=volume,scenes=scenes,sceneFilter=int(sceneFilter[0][0]),campaigns=campaigns,campaignFilter=campaignFilter)
